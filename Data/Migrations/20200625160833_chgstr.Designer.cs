...
namespace CarBooking.Data.Migrations
{
    ...
    [Migration("20200625160833_chgstr")]
    partial class chgstr
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarBooking.Models.CarBookingz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CarBookingz");
                });

            modelBuilder.Entity("CarBooking.Models.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CarBooking.Models.CarBookingz", b =>
                {
                    ...
                    b.HasOne("CarBooking.Models.Car", "Car")
                        .WithMany("CarBookingz")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarBooking.Models.Status", "Status")
                        .WithMany()
